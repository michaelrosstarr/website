    ...
    <nav className='center nav'>
      ...
      {showColorList &&
        <>
          ...
          {/* // eslint-disable */}
          <div className={`color__selector__div animate__animated animate__fast ${colorAnimate}`} style={{ position: "fixed", top: 0, right: 0, borderBottom: `2px ${cookies.color} solid`, transition: "0.1s" }} onClick={() => closeModal()}>
            {/* eslint-disable   */}
